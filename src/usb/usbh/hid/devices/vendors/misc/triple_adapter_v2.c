...
void process_triple_adapter_v2(uint8_t dev_addr, uint8_t instance, uint8_t const* report, uint16_t len) {
  ...
  if (diff_report_triple_adapter_v2(&prev_report[dev_addr-1][instance], &update_report) )
  {
    ...
    buttons = (((dpad_up)              ? JP_BUTTON_DU : 0) |
               ...
               ((update_report.ntt_0)  ? JP_BUTTON_L3 : 0) |
               ((update_report.ntt_1)  ? JP_BUTTON_R3 : 0) |
               ((update_report.l)      ? JP_BUTTON_L1 : 0) |
               ((update_report.r)      ? JP_BUTTON_R1 : 0) |
               ((update_report.ntt_2)  ? JP_BUTTON_L2 : 0) |
               ((update_report.ntt_3)  ? JP_BUTTON_R2 : 0) |
               ((update_report.ntt_4)  ? JP_BUTTON_A1 : 0) |
               ((update_report.ntt_5)  ? JP_BUTTON_A2 : 0));
