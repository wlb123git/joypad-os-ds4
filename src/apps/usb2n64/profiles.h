// profiles.h - USB2N64 Profile Definitions
//
// Button mapping profiles for USB to N64 adapter.
...
#ifndef USB2N64_PROFILES_H
#define USB2N64_PROFILES_H
