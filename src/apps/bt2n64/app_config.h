/*
 * N64 Console LED Configuration (BT2N64)
...
// Player 1 - Dark Blue (N64 controller color)
#define LED_P1_R 0
#define LED_P1_G 0
#define LED_P1_B 48
...
#define NEOPIXEL_PATTERN_4 pattern_yellow
#define NEOPIXEL_PATTERN_5 pattern_purple
